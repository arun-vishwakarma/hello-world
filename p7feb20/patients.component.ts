...
export class PatientsComponent implements OnInit, OnDestroy {
   ...
   */
  setEventLogData(bpObserVation: any, htn: any) {
    ...
    console.log("evevt log F", this.eventLogData);
    ...
    this.eventLogFilterOptions.endDate = "2019-06-20";
  ...
  clearInputFilters(expr: string) {
    switch (expr) {
      ...
      case "type":
        ...
        this.eventLogFilterOptions.mcpcCheckedNo = this.eventLogFilterOptions.mcpcCheckedYes = this.eventLogFilterOptions.deviceCheckedKnown = this.eventLogFilterOptions.deviceCheckedUnKnown = false;
        this.filterEventLogData();
        break;
      case "mcpc":
        this.eventLogFilterOptions.metClinicalProfileCriteria = "";
  ...
  assignEventDataObject(arr: Array<any>, type: string) {
    return arr.map(data => {
